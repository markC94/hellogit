...
--    self.kind:setVisible(false)
    ...
    local Node_1=self.kindNode:getChildByName("Node_1")
    local five=Node_1:getChildByName("5")
    self.num1=five:getChildByName("5toushi")
    local numbg=five:getChildByName("zhengchang5")
    self.num2=numbg:getChildByName("5zhengchang")
end

function KindLayer:updateKindNum(num)
    self.num1:setTexture("5ofkindeffect/"..num.."toushi.png")
    self.num2:setTexture("5ofkindeffect/"..num.."zhengchang.png")
end
